  ...
  return (
    <section ref={ref} className="relative h-[280vh]">
      ...
      <div className="sticky top-0 flex h-screen items-center justify-center overflow-hidden">
        ...
        >
          <p className="text-xs font-semibold tracking-[0.3em] text-[#b7a5f7] uppercase">
            About us
          </p>
          ...
          <p className="mt-6 text-base leading-relaxed text-zinc-500 sm:text-lg">
            Strategy, design, and engineering under one roof &ndash; moving at startup speed, with
            the craft of a senior team.
          </p>
        </motion.div>
      </div>
    </section>
